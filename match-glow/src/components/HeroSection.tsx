      ...
      <div className="relative z-20 text-center px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-6 leading-tight">
            <span className="hero-text animate-glow">Predict Customer</span>
            <br />
            <span className="hero-text">Churn</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Advanced AI-powered churn prediction with RAG architecture. 
            Analyze, predict, and understand customer behavior with intelligent vector search.
          </p>
        </motion.div>
        ...
        >
          {[
            { title: "Churn Prediction", desc: "Predict churn with LightGBM" },
            { title: "Explainable AI", desc: "Understand predictions with SHAP" },
            { title: "RAG Architecture", desc: "Contextual explanations with RAG" }
          ].map((feature, i) => (
            <motion.div
              key={i}

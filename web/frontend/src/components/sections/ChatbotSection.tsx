              ...
              <div className="space-y-3">
                {suggestedQuestions.map((question, index) => (
                  <Button
                    ...
                    className="w-full text-left justify-start h-auto p-3 leading-relaxed glass-button border border-border/50 hover:border-primary/30 whitespace-normal break-words min-h-[2.5rem]"
                  >
                    <div className="block w-full">{question}</div>
                  </Button>
                ))}
              </div>
            </Card>
